...
refreshPage() {
  ...
  render() {
    return (
      <div className='Mdropmenu' onClick={this.refreshPage}>
        <ul>
            <li className='Mcategory__item'><Link to={"/productList/category/BEST"}>BEST</Link></li>
            ...
            <li className='Mcategory__item'><Link to={"/productList/category/TOP"}>TOP</Link>
            <ul>
            ...
            <li className='Mcategory__item'><Link to={"/productList/category/BOTTOM"}>BOTTOM</Link>
            <ul>
            ...
            <li className='Mcategory__item'><Link to={"/productList/category/DRESS"}>DRESS</Link>
            <ul>
            <li><Link to={"/productList/category/원피스"}>원피스</Link></li>
            </ul>
            </li>

            <li className='Mcategory__item'><Link to={"/productList/category/ACC"}>ACC</Link>
            <ul>
